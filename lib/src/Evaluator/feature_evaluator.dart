      ...
      for (var rule in targetFeature.rules!) {
        ...
        if (rule.force != null) {
          if (rule.condition != null &&
            ...
            logger.info(['Skip rule because of condition']);
            continue; // Skip to the next rule
          }
          ...
          if (rule.tracks != null) {
            for (var track in rule.tracks!) {
              if (track.featureResult?.experiment != null &&
                  track.featureResult?.experimentResult != null) {
          ...
          if (rule.range == null) {
            if (rule.coverage != null) {
              ...
              String? attributeValue =
                  context.userContext.attributes?[key].toString();
